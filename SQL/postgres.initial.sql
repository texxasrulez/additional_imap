...
CREATE SEQUENCE additional_imap_seq;

CREATE TABLE IF NOT EXISTS additional_imap (
  id int check (id > 0) NOT NULL DEFAULT NEXTVAL ('additional_imap_seq'),
...
CREATE SEQUENCE additional_imap_hosts_seq;

CREATE TABLE IF NOT EXISTS additional_imap_hosts (
  id int NOT NULL DEFAULT NEXTVAL ('additional_imap_hosts_seq'),
...
CREATE SEQUENCE cache_tables_seq;

CREATE TABLE IF NOT EXISTS cache_tables (
  id int NOT NULL DEFAULT NEXTVAL ('cache_tables_seq'),
